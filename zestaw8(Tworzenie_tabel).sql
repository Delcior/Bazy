...
--2.1 Dodaædo tabeli klientkolumnê umo¿liwiaj¹c¹ przechowywanie adresu email. 
ALTER TABLE klient ADD (EMAIL VARCHAR(35) NULL);

--2.2 Zmodyfikowaæ kolumnê addr_zipw ten sposób, aby mia³a nazwê addr_postalcode i umo¿liwia³a przechowywanie 7 znaków 
